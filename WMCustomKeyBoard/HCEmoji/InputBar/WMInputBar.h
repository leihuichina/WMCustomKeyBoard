...
@interface WMInputBar : UIView

#pragma mark - -----Properties-----
@property (strong, nonatomic) WMEmojiKeyboard *keyboard;
 ...
 *@param  ImgStyle类型有:  ImgStyleWithVoice，ImgStyleWithVideo，ImgStyleWithPhoto，ImgStyleWitfontamera，ImgStyleWithEmoji
