...
@interface WMInputBar ()<UITextViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource>
...
- (instancetype)initWithStyle:(InputBarStyle)style {
    ...
    if (self) {
        _keyboard = [WMEmojiKeyboard sharedKeyboard];
